...
export default function RightTimeLineRepositoryCard(item: TimelineRepositoryItem) {
	return (
		<div className="my-20 flex justify-between items-center w-full right-timeline">
			...
			<div className="order-1 bg-gray-400 rounded-lg shadow-xl w-39 px-6 py-3">
				...
				<div className="flex flex-col justify-center items-center">
					<div className="flex flex-col justify-center items-center">
						<div className="font-bold text-gray-800 text-21">{item.Name}</div>
						{item.ForkName && (
					...
					<div className="font-normal text-gray-800 text-18 text-center my-0">
						{item.Description}
					</div>
					<div className="flex my-1">
						...
						<div className="border-l-2 border-gray-800 ml-7 mr-10"></div>
						<div className="">
