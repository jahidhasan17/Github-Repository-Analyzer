		...
		<nav className="mx-auto px-6 pt-6 pb-3 bg-slate-100">
			<div className="flex items-center justify-between">
				<Link to="/" className="flex items-center">
					...
					<h3 className="ml-3 text-2xl border-slate-300 border-l-2 pl-2 hidden md:block">
						Ultimate Github Repository Analyzer
					</h3>
				</Link>
			</div>
			<div className="flex justify-center mt-3">
				<Link to="/search-on-repos">
					<button
						className={`text-xl hover:underline underline-offset-16 ${
							window.location.href.includes("search-on-repos") ? "underline" : ""
						}`}
					>
						Search Repository
					</button>
