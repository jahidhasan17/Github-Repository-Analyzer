...
const ENCRYPTION_KEY: any = process.env.SC_ENCRYPTION_KEY; // Must be 256 bits (32 characters)
const IV_LENGTH: number = 16; // For AES, this is always 16

export function encrypt(text: string, encryptionKey: any = process.env.SC_ENCRYPTION_KEY): string {
...
export function decrypt(text: string, encryptionKey: any = process.env.SC_ENCRYPTION_KEY): string {
